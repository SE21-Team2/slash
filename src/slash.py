...
This is the main file for the Slash application. It parses the options and prints the result
...
def main():
    ...
    parser.add_argument('--sort', type=str, nargs='+',
                        help="Sort according to re (relevance: default), pr (price) or ra (rating)", default="re")
    ...
    parser.add_argument('--cd', type=str, help="Change directory to save CSV file with search results",
                        default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "csvs"))
