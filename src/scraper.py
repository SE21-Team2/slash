...
def searchEtsy(query):
    ...
    for item in soup.select('.wt-grid__item-xs-6'):
        ...
        img = str(item)
        # This is to make sure that the ValueError generated by substring in python does not generate an error for the application itself. 
        # This is also to stpo iterations when there is no image left to be scraped
        try:
